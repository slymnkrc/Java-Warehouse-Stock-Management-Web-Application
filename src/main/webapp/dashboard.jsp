                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="d-grid gap-2">
                            <a href="customer.jsp">
                                <button class="btn btn-primary btn-lg mb-2 text-left custom_btn button1" style="width: 100%" type="button">
                                    <i class="fas fa-user-plus"></i> Müşteri Ekle
                                </button>

                            </a>
                            <a href="products.jsp">
                                <button class="btn btn-warning btn-lg mb-2 text-left custom_btn button2" style="width: 100%" type="button">
                                    <i class="fa fa-shopping-basket"></i> Ürün Ekle
                                </button>

                            </a>
                            <a href="boxAction.jsp">
                                <button class="btn btn-success btn-lg mb-2 text-left custom_btn button3"style="width: 100%" type="button">
                                    <i class="fa fa-shopping-cart"></i> Sipariş Ekle
                                </button>

                            </a>
                            <a href="payIn.jsp">
                                <button class="btn btn-danger btn-lg mb-2 text-left  custom_btn button4" style="width: 100%" type="button">
                        ...
                        <div class="card mb-3">
                            <div class="card-body d-flex flex-row justify-content-between"
                                ...
                                <div class="card-left">
                                    ...
                                    <div class="card-title"
                                         style="font-weight: 700; margin-bottom: 0; letter-spacing: 0.5px;">Sipariş
                                    </div>
                                </div>
                                <div class="card-right">
                                    <div style="font-size: 1.8rem;font-weight: 700; color: #244785;"><span>2</span>
                                    </div>
                                </div>
                            </div>
                        </div>
